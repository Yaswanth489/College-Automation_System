...
<body class="single_slider  slider_bg_1">
                    <center>
    <h1>Share Announcements</h1>
    <?php
    	if(isset($_POST['SubmitButton'])){
    		$a=$_POST['announcement'];
    		$s=$conn->prepare("insert into announcement(announcement,tid,dept,date) values(?,?,?,?)");
    		$s->bind_param("ssss",$a,$res['tid'],$res['department'],$date);
    		$s->execute();
...
<form  action="" method="post">
    ...
    <textarea rows="5" cols="50" name="announcement" placeholder="Announce something--"></textarea><br>
